...
namespace Boggle
{
    public class BoggleService : IBoggleService
    {
        ...
        public void CancelJoinRequest(User UserToken)
        {
            lock (sync)
            {
        ...
        public Ret4 GameStatus(string brief,  string GameID)
        {
        ...
        public ReturnGame JoinGame(NewGame _game)
        {
            lock (sync)
            {
        ...
        public _Score Score(string UserToken, string Word, string GameID)
        {
            lock (sync)
            {
