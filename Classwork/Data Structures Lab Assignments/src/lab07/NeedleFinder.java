...
public class NeedleFinder {
	public static void main(String[] args) {
		...
		Pattern HEX_PATTERN    = Pattern.compile("u0868926\\W([0-9A-Fa-f]{10})\\W");
		Pattern TIME_PATTERN   = Pattern.compile("u0868926[1900-2999][ /.-][0[1-9]|1[012]][ /.-][0[1-9]|1[012]|3[01]]\\W[0-9A-Fa-f]{8}\\W");
		Pattern REPEAT_PATTERN = Pattern.compile("^$");
		String possiblePassphrase;
		try {
			String haystack = new String(Files.readAllBytes(Paths.get("src/lab07/haystack.txt")));
			...
			String needles = new String(Files.readAllBytes(Paths.get("src/lab07/needles.txt")));
